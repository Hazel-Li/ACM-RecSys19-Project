...
class SessionDataset:
    ...
    def __init__(self, data, sep='\t', session_key='session_id', item_key='item_id', time_key='timestamp', n_samples=-1, itemmap=None, time_sort=False):
        """
        Args:
    ...
    def get_click_offsets(self):
        ...
        """
        offsets = np.zeros(self.df[self.session_key].nunique() + , dtype=np.int32)
...
def create_model(args):   
    ...
    gru2, gru2_states = CuDNNGRU(hidden_units, stateful=True, return_state=True)(drops2)
    drop3 = Dropout(0.25)(gru2)
    predictions = Dense(args.train_n_items, activation='softmax')(drops3)
